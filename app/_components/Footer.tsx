...
export default function Footer() {
    return (
        <footer className="w-full bottom-0 border-t border-foreground/5">
            <div className="flex flex-col md:flex-row justify-between items-center w-full px-4 md:px-10 py-12 mx-auto">
                <div className="flex flex-col items-center md:items-start gap-4 mb-8 md:mb-0">
                    ...
                    <p className="text-xs uppercase tracking-widest text-muted-foreground">© 2024 WardPass. Security Protocols Engaged.</p>
                </div>
