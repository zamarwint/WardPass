...
export default function DesktopOnly() {
    ...
    return (
        <div className="lg:hidden flex flex-col gap-8 items-center justify-center w-full h-full text-center px-8">
            ...
            <p className="text-muted-foreground">The WardPass vault dashboard is optimized only for desktop environments to ensure maximum precision and security. To use WardPass, please access this site on a desktop computer.</p>
