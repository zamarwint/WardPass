...
export default function TopBar() {
    ...
    return (
        <>
            <div className="font-geist flex items-center justify-between w-full p-2 bg-card/40 backdrop:blur-sm border-b border-muted">
                <div className="flex items-center justify-center text-primary gap-0.5 cursor-pointer" onClick={() => router.push('/')}>
                    <Image src="/../../../icon.png" alt="logo" width={0} height={0} className="size-8" loading="eager" />
                    <span className="text-xl tracking-tighter font-bold">WARDPASS</span>
                </div>
                <Search />
                <div className="flex items-center gap-2">
                    <Button size="lg" variant="ghost" onClick={() => setBannerOpen(!bannerOpen)}>
                    ...
                    <Button size="icon" variant="ghost" onClick={handleBugPlayClick}>
