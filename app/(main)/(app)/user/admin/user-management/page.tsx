...
import HandleUserSessions from "../_components/users/UserSessions";
import HandleListUsers from "../_components/users/Users";
import AdminCreateUser from "../_components/users/CreateUser";
    ...
    return (
        <motion.div className="flex flex-col gap-10 items-start justify-start pt-60 px-10 py-5">
            <Field className="flex flex-col gap-10">
                <FieldGroup>
                    <Field>
                        <FieldTitle className="text-xl">Users</FieldTitle>
                    ...
                    <Field>
                        <FieldContent className="space-y-5">
                            <ToggleGroup type="single" value={selectedContent} onValueChange={(value) => setSelectedContent(value)}>
                                ...
                                <ToggleGroupItem size="sm" value="create-user" className="text-md p-6 rounded-xl">
                                    Create User
                                </ToggleGroupItem>
                            </ToggleGroup>
                            {selectedContent === 'users' && <HandleListUsers />}
                            {selectedContent === 'user-sessions' && <HandleUserSessions />}
                            {selectedContent === 'create-user' && <AdminCreateUser />}
                        </FieldContent>
                    </Field>
                </FieldGroup>
            </Field>
